...
public class OrderShippingAdminServlet extends HttpServlet {

    private static final long serialVersionUID = -4935290844188757634L;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Order> list = orderService.GetAllOrderShipping();
        ...
        request.getRequestDispatcher("./views-admin/orders/OrdersShipping.jsp").forward(request, response);
    }
}
