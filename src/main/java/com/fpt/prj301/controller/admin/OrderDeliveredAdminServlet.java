...
public class OrderDeliveredAdminServlet extends HttpServlet {

    private static final long serialVersionUID = 2866941130852157542L;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Order> list = orderService.GetAllOrderDelivered();
        ...
        request.getRequestDispatcher("./views-admin/orders/OrdersDelivered.jsp").forward(request, response);
    }
}
