...
public class ProductsByBrandServlet extends HttpServlet {

    private static final long serialVersionUID = -482622890437978743L;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int count = productService.CountProductByBrand(id);
        int endPage = count / 9;
        int start = ((page * 9) - 8);
        int end = (page * 9);
        if (count % 9 != 0) {
        ...
        List<Product> list = productService.GetProductByBrand(id, page);
        ...
        request.getRequestDispatcher("./views-admin/products/ProductsByBrand.jsp").forward(request, response);
    }
}
