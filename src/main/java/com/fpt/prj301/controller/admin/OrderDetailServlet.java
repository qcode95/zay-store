...
public class OrderDetailServlet extends HttpServlet {
    ...
    private static final long serialVersionUID = -1980994735521974736L;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("./views-admin/order-detail/OrderDetail.jsp").forward(request, response);
    }
}
