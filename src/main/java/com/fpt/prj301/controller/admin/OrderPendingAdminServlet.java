...
public class OrderPendingAdminServlet extends HttpServlet {

    private static final long serialVersionUID = 3056347000217822865L;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Order> list = orderService.GetAllOrderPending();
        ...
        request.getRequestDispatcher("./views-admin/orders/OrdersPending.jsp").forward(request, response);
    }
}
