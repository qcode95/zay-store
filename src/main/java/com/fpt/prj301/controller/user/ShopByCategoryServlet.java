...
public class ShopByCategoryServlet extends HttpServlet {

    private static final long serialVersionUID = -3658308246176468805L;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> listProduct = productService.GetProductByCategory(id, page);
