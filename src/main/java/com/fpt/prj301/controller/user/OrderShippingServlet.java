...
public class OrderShippingServlet extends HttpServlet {
    ...
    private static final long serialVersionUID = 4843180967287874223L;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user == null) {
            ...
            List<Order> list = orderService.UserOrdersShipping(user.getId());
            ...
            request.getRequestDispatcher("./views/order/OrderShipping.jsp").forward(request, response);
        }
    }
