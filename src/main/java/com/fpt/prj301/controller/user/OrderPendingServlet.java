...
public class OrderPendingServlet extends HttpServlet {
    ...
    private static final long serialVersionUID = 1967528763654994169L;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user == null) {
            ...
            List<Order> list = orderService.UserOrdersPending(user.getId());
            ...
            request.getRequestDispatcher("./views/order/OrderPending.jsp").forward(request, response);
        }
    }
}
