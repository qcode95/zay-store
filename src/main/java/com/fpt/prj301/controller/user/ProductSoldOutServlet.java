...
public class ProductSoldOutServlet extends HttpServlet {

    private static final long serialVersionUID = 2218368005314739254L;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("./views/product-single/ProductSoldOut.jsp").forward(request, response);
    }
