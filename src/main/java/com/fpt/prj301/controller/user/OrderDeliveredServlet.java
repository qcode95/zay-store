...
public class OrderDeliveredServlet extends HttpServlet {
    ...
    private static final long serialVersionUID = 686530158861018300L;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user == null) {
            ...
            List<Order> list = orderService.UserOrdersDelivered(user.getId());
            ...
            request.getRequestDispatcher("./views/order/OrderDelivered.jsp").forward(request, response);
        }
    }
