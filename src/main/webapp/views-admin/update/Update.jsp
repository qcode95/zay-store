                                    ...
                                    <div class="col-12">
                                        <div class="sherah-breadcrumb mg-top-30">
                                            ...
                                            <ul class="sherah-breadcrumb__list"> 
                                                ...
                                                <li class="active"><a href="<%=request.getContextPath()%>/update?id=<%=product.getId()%>">Update Product</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="sherah-page-inner sherah-border sherah-basic-page sherah-default-bg mg-top-25 p-0">
                                    <form class="sherah-wc__form-main" action="./update?id=<%=product.getId()%>" method="post" id="addForm" enctype="multipart/form-data">
                                        <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group__input">
                                                                    <input class="sherah-wc__form-input" id="name" value="<%=product.getName()%>"
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group__input">
                                                                    <input class="sherah-wc__form-input" id="price" value="<%=product.getPrice()%>"
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group__input">
                                                                    <input class="sherah-wc__form-input" id="rating" value="<%=product.getRating()%>"
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group__input">
                                                                    <textarea class="tinymce" id="description" placeholder="Type here" type="text" name="description">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-group__input" name="category" aria-label="Default select example">
                                                                    <option value="1" <%= product.getCategory() == 1 ? "selected=\"true\"" : ""%>>Sneakers</option>
                                                                    <option value="2" <%= product.getCategory() == 2 ? "selected=\"true\"" : ""%>>Sport Shoes</option>
                                                                    <option value="3" <%= product.getCategory() == 3 ? "selected=\"true\"" : ""%>>High Heels</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-group__input" name="brand" aria-label="Default select example">
                                                                    <option value="1" <%= product.getBrand() == 1 ? "selected=\"true\"" : ""%>>Nike</option>
                                                                    <option value="2" <%= product.getBrand() == 2 ? "selected=\"true\"" : ""%>>Converse</option>
                                                                    <option value="3" <%= product.getBrand() == 3 ? "selected=\"true\"" : ""%>>Vans</option>
                                                                    <option value="4" <%= product.getBrand() == 4 ? "selected=\"true\"" : ""%>>Puma</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group__input">
                                                                    <input class="sherah-wc__form-input" id="quantity" value="<%=product.getQuantity()%>"
                                                                           placeholder="Type here" type="number" name="quantity">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group__input">
                                                                    <input class="sherah-wc__form-input" id="color" value="<%=product.getColor()%>"
                                                                           placeholder="Type here" type="text" name="color">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                <div class="image-upload-group">
                                                    <div class="image-upload-group__single row">
                                                        <img id="image1" src="./<%=product.getImage()%>" style="width: 600px; height: 190px">
                                                        <!-- Progress bar -->
                                                    ...
                                                    <div class="image-upload-group__single image-upload-group__single--upload">
                                                        <input type="file" class="btn-check" name="image" id="image" onchange="uploadImage()">
