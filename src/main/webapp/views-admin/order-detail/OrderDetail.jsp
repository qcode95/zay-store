                                                    ...
                                                    <tbody class="sherah-table__body">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="sherah-table__column-4 sherah-table__data-4">
                                                                <div class="sherah-table__product-content">
                                                                    <p class="sherah-table__product-desc">$<%=oDetail.getAmount()%></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <% }%>
                                                ...
                                                <table id="sherah-table__orderv1" class="sherah-table__main sherah-table__main--orderv1 sherah-border">
                                                    ...
                                                    <tbody class="sherah-table__body">
                                                        <tr>
                                                            <td class="sherah-table__column-1 sherah-table__data-1">
                                                                <div class="sherah-table__product-name">
                                                                    <h4 class="sherah-table__product-gateway"><%=us.GetNameById(transaction.getUid())%></h4>
                                                                </div>
                                                            </td>
                                                            <td class="sherah-table__column-2 sherah-table__data-2">
                                                                <div class="sherah-table__product-content">
                                        ...
                                        <div class="sherah-contact-card sherah-default-bg sherah-border mg-top-30">
                                            ...
                                            <div class="sherah-vcard__body">
                                                ...
                                                <div class="sherah-vcard__content">
                                                    <h4 class="sherah-vcard__title"><%=us.GetNameById(transaction.getUid())%></h4>
                                                    <ul class="sherah-vcard__contact">
                                                        <li><a href="tel:+84<%=us.GetMobileById(transaction.getUid())%>">
                                                                ...
                                                                </svg>(+84) <%=us.GetMobileById(transaction.getUid())%></a>
                                                        </li>
                                                        <li>
                                                            <a href="mailto:<%=us.GetEmailById(transaction.getUid())%>">
                                                                ...
                                                                </svg><%=us.GetEmailById(transaction.getUid())%></a>
                                                        </li>
                                                        <li>
                                                            <a href="#">
                                                                <i class="fa-solid fa-location-dot sherah-color1"></i>
                                                                <%=us.GetAddressById(transaction.getUid())%>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
