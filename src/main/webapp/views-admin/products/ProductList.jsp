                                    ...
                                    <div class="col-12 sherah-flex-between">
                                        ...
                                        <div class="sherah-breadcrumb">
                                            ...
                                            <ul class="sherah-breadcrumb__list"> 
                                                ...
                                                <li class="active"><a href="<%=request.getContextPath()%>/product-list">Product List</a></li>
                                            </ul>
                                        </div>
                                ...
                                <div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                    <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                        ...
                                        <thead class="sherah-table__head">
                                            <tr>
                                                <th class="sherah-table__column-1 sherah-table__h1">Product ID</th>
                                                <th class="sherah-table__column-2 sherah-table__h2">Product Name</th>
                                                <th class="sherah-table__column-5 sherah-table__h3">Product Price</th>
                                                <th class="sherah-table__column-3 sherah-table__h3">Product Color</th>
                                                <th class="sherah-table__column-7 sherah-table__h5">Product Category</th>
                                                <th class="sherah-table__column-7 sherah-table__h5">Product Brand</th>
                                                <th class="sherah-table__column-7 sherah-table__h7">Stock</th>
                                                <th class="sherah-table__column-7 sherah-table__h5">Product Image</th>
                                            ...
                                            <tr>
                                                    ...
                                                    <div class="sherah-language-form__input">
                                                        ...
                                                        <p class="crany-table__product--number">
                                                            <a href="<%=request.getContextPath()%>/product-list" 
                                                               class="sherah-color1">#<%=product.getId()%>
                                                            </a>
                                                        </p>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-2 sherah-table__data-2">
                                                    <div class="sherah-table__product-content">
                                                        <h5 class="sherah-table__product-desc"><%=product.getName()%></h5>
                                                        <p><%=product.getDescription()%></p>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-3 sherah-table__data-3">
                                                    <p class="sherah-table__product-desc">$<%=product.getPrice()%></p>
                                                </td>
                                                <td class="sherah-table__column-3 sherah-table__data-3">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc"><%=product.getColor()%></p>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-5 sherah-table__data-5">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc"><%=ps.GetCategoryName(product.getCategory())%></p>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-5 sherah-table__data-5">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc"><%=ps.GetBrandName(product.getBrand())%></p>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-7 sherah-table__data-7">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc"><%=product.getQuantity()%></p>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-5 sherah-table__data-5">
                                                    <div class="sherah-table__product-content">
                                                        <img class="img-thumbnail" src=".<%=product.getImage()%>" alt="Product Image" style="border-radius: 10px"/>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-8 sherah-table__data-8">
                                                    <div class="sherah-table__status__group">
                                                        <a href="<%=request.getContextPath()%>/update?id=<%=product.getId()%>" class="sherah-table__action sherah-color4 sherah-color4__bg--opactity">
                                                            <i class="fa-regular fa-pen-to-square"></i>
                                                        </a>
                                                        <a href="#" onclick="handleDelete(<%=product.getId()%>)" class="sherah-table__action sherah-color2 sherah-color2__bg--opactity">
