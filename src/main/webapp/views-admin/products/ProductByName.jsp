                                                ...
                                                <div class="row mg-top-40">
                                                    <div class="sherah-pagination">
                                                        <ul class="sherah-pagination__list">
                                                            <c:if test="${tag > 1}">
                                                                <li class="sherah-pagination__button"><a href="./search-product-name?page=${tag - 1}&search=${txtS}"><i class="fas fa-angle-left"></i></a></li>
                                                                    </c:if>

                                                            <c:forEach begin="${(tag - 5) < 1 ? 1 : (tag - 5)}" end="${(tag + 5) > endP ? endP : (tag + 5)}" var="i">
                                                                <li class="${tag == i ? "active" : ""}"><a href="./search-product-name?page=${i}&search=${txtS}">${i}</a></li>
                                                                </c:forEach>

                                                            <c:if test="${tag < endP}">
                                                                <li class="sherah-pagination__button"><a href="./search-product-name?page=${tag + 1}&search=${txtS}"><i class="fas fa-angle-right"></i></a></li>
                                                                    </c:if>
                                                        </ul>
                                                    </div>
                                                </div>
