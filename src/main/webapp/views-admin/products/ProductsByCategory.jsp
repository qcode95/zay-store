                                    ...
                                    <div class="col-12 sherah-flex-between">
                                        ...
                                        <div class="sherah-breadcrumb">
                                            ...
                                            <ul class="sherah-breadcrumb__list"> 
                                                ...
                                                <li class="active"><a href="<%=request.getContextPath()%>/products">Product List </a></li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="col-xxl-9 col-lg-8 col-12">
                                        <div class="sherah-breadcrumb__right mg-top-30">
                                            <div class="sherah-breadcrumb__right--first">
                                                ...
                                                <p>Showing <%=start%>–<%=end%> of <%=count%> results</p>
                                            </div>
                                                ...
                                                <div class="row mg-top-40">
                                                    <div class="sherah-pagination">
                                                        <ul class="sherah-pagination__list">
                                                            <c:if test="${tag > 1}">
                                                                <li class="sherah-pagination__button"><a href="./products-category?id=<%=id%>&page=${tag - 1}"><i class="fas fa-angle-left"></i></a></li>
                                                                    </c:if>

                                                            <c:forEach begin="${(tag - 5) < 1 ? 1 : (tag - 5)}" end="${(tag + 5) > endP ? endP : (tag + 5)}" var="i">
                                                                <li class="${tag == i ? "active" : ""}"><a href="./products-category?id=<%=id%>&page=${i}">${i}</a></li>
                                                                </c:forEach>

                                                            <c:if test="${tag < endP}">
                                                                <li class="sherah-pagination__button"><a href="./products-category?id=<%=id%>&page=${tag + 1}"><i class="fas fa-angle-right"></i></a></li>
                                                                    </c:if>
                                                        </ul>
                                                    </div>
                                                </div>
