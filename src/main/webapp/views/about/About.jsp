...
<html>
    ...
    <body>
        ...
        <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
            <div class="container">
                <div class="row">
                    <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(${pageContext.request.contextPath}/assets/images/about.jpg);">
                    ...
                    <div class="col-md-7 py-md-5 wrap-about pb-md-5 ftco-animate">
                        ...
                        <div class="pb-md-5 pb-4">
                            ...
                            <p><a href="<%=request.getContextPath()%>/shop?page=1" class="btn btn-primary">Shop now</a></p>
                        </div>
                    </div>
                </div>
            </div>
