                                            ...
                                            <div class="sherah-header__right">
                                                ...
                                                <div class="sherah-header__author sherah-flex__center--top">
                                                    ...
                                                    <div class="sherah-header__author--info sherah-dflex sherah-dflex__base">
                                                        <h4 class="sherah-header__author--title  sherah-dflex sherah-dflex__column"><%=user.getName()%> <span class="sherah-header__author--text">Việt Nam</span></h4>
                                    ...
                                    <div class="col-12">
                                        <div class="sherah-breadcrumb mg-top-30">
                                            ...
                                            <ul class="sherah-breadcrumb__list"> 
                                                ...
                                                <li class="active"><a href="<%=request.getContextPath()%>/views/admin/TermsAndConditions.jsp">Terms & Conditions</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
