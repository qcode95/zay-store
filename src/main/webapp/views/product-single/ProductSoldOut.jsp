    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                        <h3><%=product.getName()%> (SOLD OUT)</h3>
                        ...
                        <form action="./buy-now?id=<%=product.getId()%>" method="post" id="buyForm">
                            ...
                            <p>
                                <a href="" class="btn btn-primary py-3 px-5 mr-2">Sold Out</a>
                                <a href="<%=request.getContextPath()%>/notify?id=<%=product.getId()%>" class="btn btn-black py-3 px-5">NOTIFY ME WHEN AVAILABLE</a>
                            </p>
                        </form>
                    </div>
                </div>
        ...
        <script>
            function addToCartSingle() {
                ...
                window.location.href = "<%=request.getContextPath()%>/add-to-cart-single?id=<%=product.getId()%>&size=" + size;
            }
        </script>
        <script>
